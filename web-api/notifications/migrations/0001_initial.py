...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Deleting model 'NotificationGame'
        db.delete_table(u'notifications_notificationgame')

        # Deleting model 'NotificationFriend'
        db.delete_table(u'notifications_notificationfriend')
