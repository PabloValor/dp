...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Game.owner'
        db.alter_column(u'games_game', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['games.Player']))
        # Deleting field 'Player.game'
        db.delete_column(u'games_player', 'game_id')
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Game.owner'
        db.alter_column(u'games_game', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
        # Adding field 'Player.game'
        db.add_column(u'games_player', 'game',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['games.Game'], null=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'tournaments.match': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 6, 1, 0, 0)'}),
            'fixture': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['tournaments.Fixture']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
