...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GamePlayer.anotherChance'
        db.alter_column(u'games_gameplayer', 'anotherChance', self.gf('django.db.models.fields.NullBooleanField')(null=True))

    def backwards(self, orm):

        # Changing field 'GamePlayer.anotherChance'
        db.alter_column(u'games_gameplayer', 'anotherChance', self.gf('django.db.models.fields.BooleanField')())
    ...
    models = {
        ...
        u'games.gameplayer': {
            ...
            'anotherChance': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'game': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['games.Game']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'player': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['games.Player']"}),
