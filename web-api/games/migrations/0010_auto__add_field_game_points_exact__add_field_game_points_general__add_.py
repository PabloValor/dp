...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Game.points_exact'
        db.add_column(u'games_game', 'points_exact',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=3),
                      keep_default=False)

        # Adding field 'Game.points_general'
        db.add_column(u'games_game', 'points_general',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Game.points_classic'
        db.add_column(u'games_game', 'points_classic',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=2),
                      keep_default=False)

        # Adding field 'Game.points_double'
        db.add_column(u'games_game', 'points_double',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Game.points_exact'
        db.delete_column(u'games_game', 'points_exact')

        # Deleting field 'Game.points_general'
        db.delete_column(u'games_game', 'points_general')

        # Deleting field 'Game.points_classic'
        db.delete_column(u'games_game', 'points_classic')

        # Deleting field 'Game.points_double'
        db.delete_column(u'games_game', 'points_double')
