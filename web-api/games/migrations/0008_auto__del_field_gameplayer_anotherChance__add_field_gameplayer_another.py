...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'GamePlayer.anotherChance'
        db.delete_column(u'games_gameplayer', 'anotherChance')

        # Adding field 'GamePlayer.another_chance'
        db.add_column(u'games_gameplayer', 'another_chance',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'GamePlayer.anotherChance'
        db.add_column(u'games_gameplayer', 'anotherChance',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'GamePlayer.another_chance'
        db.delete_column(u'games_gameplayer', 'another_chance')
    ...
    models = {
        ...
        u'tournaments.match': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 8, 9, 0, 0)'}),
            'fixture': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['tournaments.Fixture']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
