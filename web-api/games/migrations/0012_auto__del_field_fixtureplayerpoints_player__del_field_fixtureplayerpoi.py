...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FixturePlayerPoints.player'
        db.delete_column(u'games_fixtureplayerpoints', 'player_id')

        # Deleting field 'FixturePlayerPoints.game'
        db.delete_column(u'games_fixtureplayerpoints', 'game_id')

        # Adding field 'FixturePlayerPoints.gameplayer'
        db.add_column(u'games_fixtureplayerpoints', 'gameplayer',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['games.GamePlayer']),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'FixturePlayerPoints.player'
        raise RuntimeError("Cannot reverse this migration. 'FixturePlayerPoints.player' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'FixturePlayerPoints.player'
        db.add_column(u'games_fixtureplayerpoints', 'player',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['games.Player']),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'FixturePlayerPoints.game'
        raise RuntimeError("Cannot reverse this migration. 'FixturePlayerPoints.game' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'FixturePlayerPoints.game'
        db.add_column(u'games_fixtureplayerpoints', 'game',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['games.Game']),
                      keep_default=False)

        # Deleting field 'FixturePlayerPoints.gameplayer'
        db.delete_column(u'games_fixtureplayerpoints', 'gameplayer_id')
    ...
    models = {
        ...
        u'games.game': {
            ...
            'points_general': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1'}),
        ...
        u'tournaments.match': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 8, 12, 0, 0)'}),
            'fixture': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['tournaments.Fixture']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
