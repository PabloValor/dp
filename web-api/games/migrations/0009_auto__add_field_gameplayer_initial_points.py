...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GamePlayer.initial_points'
        db.add_column(u'games_gameplayer', 'initial_points',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GamePlayer.initial_points'
        db.delete_column(u'games_gameplayer', 'initial_points')
