...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PlayerFriend'
        db.create_table(u'games_playerfriend', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('player', self.gf('django.db.models.fields.related.ForeignKey')(related_name='friend_1', to=orm['games.Player'])),
            ('friend', self.gf('django.db.models.fields.related.ForeignKey')(related_name='friend_2', to=orm['games.Player'])),
            ('status', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'games', ['PlayerFriend'])
    ...
    def backwards(self, orm):
        # Deleting model 'PlayerFriend'
        db.delete_table(u'games_playerfriend')
    ...
    models = {
        ...
        u'games.playerfriend': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'friend': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'friend_2'", 'to': u"orm['games.Player']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'player': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'friend_1'", 'to': u"orm['games.Player']"}),
