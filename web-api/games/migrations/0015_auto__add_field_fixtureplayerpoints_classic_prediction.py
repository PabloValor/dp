...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FixturePlayerPoints.classic_prediction'
        db.add_column(u'games_fixtureplayerpoints', 'classic_prediction',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FixturePlayerPoints.classic_prediction'
        db.delete_column(u'games_fixtureplayerpoints', 'classic_prediction')
    ...
    models = {
        ...
        u'games.fixtureplayerpoints': {
            ...
            'classic_prediction': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        u'tournaments.match': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 9, 7, 0, 0)'}),
