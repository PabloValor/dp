...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'GamePlayer.player_invitation_status'
        db.delete_column(u'games_gameplayer', 'player_invitation_status')

        # Adding field 'GamePlayer.status'
        db.add_column(u'games_gameplayer', 'status',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'GamePlayer.player_invitation_status'
        db.add_column(u'games_gameplayer', 'player_invitation_status',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'GamePlayer.status'
        db.delete_column(u'games_gameplayer', 'status')
    ...
    models = {
        ...
        u'tournaments.match': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 8, 6, 0, 0)'}),
            'fixture': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['tournaments.Fixture']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
