...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PlayerMatchPrediction.player'
        db.delete_column(u'games_playermatchprediction', 'player_id')

        # Adding field 'PlayerMatchPrediction.gameplayer'
        db.add_column(u'games_playermatchprediction', 'gameplayer',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'PlayerMatchPrediction.player'
        raise RuntimeError("Cannot reverse this migration. 'PlayerMatchPrediction.player' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'PlayerMatchPrediction.player'
        db.add_column(u'games_playermatchprediction', 'player',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['games.Player']),
                      keep_default=False)

        # Deleting field 'PlayerMatchPrediction.gameplayer'
        db.delete_column(u'games_playermatchprediction', 'gameplayer_id')
    ...
    models = {
        ...
        u'tournaments.match': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 8, 10, 0, 0)'}),
            'fixture': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['tournaments.Fixture']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
