...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Player.initial_points'
        db.delete_column(u'games_player', 'initial_points')


    def backwards(self, orm):
        # Adding field 'Player.initial_points'
        db.add_column(u'games_player', 'initial_points',
