...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Fixture.is_playing'
        db.add_column(u'tournaments_fixture', 'is_playing',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Fixture.is_playing'
        db.delete_column(u'tournaments_fixture', 'is_playing')
