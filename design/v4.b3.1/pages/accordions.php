...
<div>To prevent that the window will scroll (if it can scroll) to the clicked header, add the class "no-scrollto" to that wrapping div (so it has "metro-accordion no-scrollto" as class. 
