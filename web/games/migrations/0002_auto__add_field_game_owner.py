...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'games_game', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='games', to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Game.owner'
        db.delete_column(u'games_game', 'owner_id')
    ...
    models = {
        ...
        u'games.game': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'games'", 'to': u"orm['auth.User']"}),
